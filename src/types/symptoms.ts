...
export const symptoms = [
  { id: 'hot_flashes', name: 'Hot Flashes', color: '#E35C78', tip: 'Try a cooling breath exercise: inhale for 4 seconds, hold for 4, exhale for 6.' },
  ...
  { id: 'energy', name: 'Energy Level', color: '#E65100', tip: 'Short 10-minute walks in nature can help boost energy levels naturally.' },
  { id: 'anxiety', name: 'Anxiety', color: '#0277BD', tip: 'Try the 5-4-3-2-1 grounding technique: acknowledge 5 things you see, 4 you can touch, 3 you hear, 2 you smell, and 1 you taste.' }
];
...
export const getSymptomColor = (symptomId: string): string => {
  ...
  if (!symptom) return '#2E8540'; // Default to accessible green
  
  return symptom.color || 
    symptomId === 'hot_flashes' ? '#E35C78' :  // Accessible pink
    symptomId === 'sleep' ? '#2E8540' :        // Accessible green
    symptomId === 'mood' ? '#9C27B0' :         // Accessible purple
    symptomId === 'energy' ? '#E65100' :       // Accessible orange
    symptomId === 'anxiety' ? '#0277BD' :      // Accessible blue
    '#795548';                                 // Accessible brown
};
